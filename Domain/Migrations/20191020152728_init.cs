        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ChangerId = table.Column<int>(nullable: true),
                    NewName = table.Column<string>(nullable: true),
                    ChangableId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllChanges_Users_ChangableId",
                        column: x => x.ChangableId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AllChanges_Users_ChangerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedMessageId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_Messages_SharedMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllChanges_ChangableId",
                table: "AllChanges",
                column: "ChangableId");

            migrationBuilder.CreateIndex(
                name: "IX_AllChanges_ChangerId",
                table: "AllChanges",
                column: "ChangerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_SharedMessageId",
                table: "Messages",
